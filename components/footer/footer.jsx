...
export default function Footer() {
  ...
  return (
    <FooterMain>
      <section>
        <div className="top">
          <Image src={top} alt="logo zukt" onClick={handleClick} />
        </div>
        <div className="container">
          <Image src={logo} alt="logo" className="svg" />
          <div className="links">
            <a>KIT GIN</a>
            <a>BAR A.DRINKS</a>
            <div className="icons">
              <Image src={Face} alt="face" className="icon svg" />
              <Image src={Insta} alt="insta" className="icon svg" />
            </div>
          </div>
        </div>
        <div className="copy">
          <div>
            ...
            <p>© 2021. a.drinks. Todos os direitos Reservados. </p>
          </div>
