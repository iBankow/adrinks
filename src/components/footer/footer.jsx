...
export default function Footer() {
  ...
  return (
    <FooterMain>
      <section>
        <div className="top">
          <img src={top} alt="logo zukt" onClick={handleClick} />
        </div>
        <div className="container">
          ...
          <div className="links">
            ...
            <p>BAR A.DRINKS</p>
            <div className="icons">
              <img src={Face} alt="face" className="icon svg" />
              <img src={Insta} alt="insta" className="icon svg" />
            </div>
          </div>
        </div>
        <div className="copy">
